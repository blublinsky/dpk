...
from header_cleanser_test_support import AbstractPythonHeaderCleanserTransformTest
from header_cleanser_transform_ray import HeaderCleanserRayTransformConfiguration


class TestPythonHeaderCleanserTransform(AbstractPythonHeaderCleanserTransformTest):
    """
